...
//displays and animates the next element after the current target function display2(event) 
{
            ...
            $(event.currentTarget).next().animate( {height: 'tottle'}, "slow");
            
}//end of display2

//attach event listerner to h3 elements to invoke display function when clicked $("h3").click(display2);

//change the background color h3 element when mouse hoverfs over it
$("h3").hover(function(){
